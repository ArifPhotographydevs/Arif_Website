            ...
            <div key={index} className="relative overflow-hidden rounded-lg shadow-lg group cursor-pointer">
              {playingVideo === video.videoId ? (
                ...
                <>
                  ...
                  >
                    <div className="w-8 h-8 sm:w-10 h-10 bg-white/90 rounded-full flex items-center justify-center mt-2 sm:mt-4 group-hover:bg-white shadow-lg transform group-hover:scale-110 transition-transform duration-300">
                      <svg className="w-5 h-5 sm:w-6 h-6 text-black" fill="currentColor" viewBox="0 0 20 20">
