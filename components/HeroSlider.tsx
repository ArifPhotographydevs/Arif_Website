      ...
      <section ref={sectionRef} className="relative w-full h-screen">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white p-6 md:p-10">
          {HERO_SLIDES.map((slide, index) => (
            ...
            >
              <p className="font-garamond text-lg md:text-2xl mb-4 tracking-widest font-bold text-yellow-200">{slide.subtitle}</p>
              <h2 className="font-garamond font-black text-4xl md:text-5xl lg:text-6xl uppercase leading-tight text-yellow-100 drop-shadow-lg">
                {slide.title}
              </h2>
            </div>
          ))}
